            ...
            if ((val.promo_image_url_abs).indexOf('missing.png') > -1){
                if (val.promotionable_type == "Store") {
                    ...
                    if ((store_details.store_front_url_abs).indexOf('missing.png') > -1) {
                        val.alt_promo_image_url = "http://assets.codecloudapp.com/sites/56ba24f16e6f641f99030000/image/png/1446826281000/stc-logo-holiday-360 copy.png";
                        val.store_image = "http://assets.codecloudapp.com/sites/56ba24f16e6f641f99030000/image/png/1446826281000/stc-logo-holiday-360 copy.png";
                    } else {
...
function renderTrending(container, template, collection){
    ...
    $.each( collection , function( key, val ) {
        ...
        if (post.image_url.indexOf('missing.png') > -1) {
            val.post_image = "http://assets.codecloudapp.com/sites/56ba24f16e6f641f99030000/image/png/1446826281000/stc-logo-holiday-360 copy.png";
        } else {
