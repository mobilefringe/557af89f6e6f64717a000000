    ...
    $.each( collection , function( key, val ) {
        if (type == "stores" || type == "category_stores"){
            if(!val.store_front_url ||  val.store_front_url.indexOf('missing.png') > -1 || val.store_front_url.length === 0){
                val.alt_store_front_url = "http://assets.codecloudapp.com/sites/57b22f546e6f6476c6020000/image/png/1446826281000/stc-logo-holiday-360 copy.png";
            } else {
    ...
    $.each( collection , function( key, val ) {
            ...
            if ((val.promo_image_url_abs).indexOf('missing.png') > -1){
                if (val.promotionable_type == "Store") {
                    ...
                    if ((store_details.store_front_url_abs).indexOf('missing.png') > -1) {
                        val.alt_promo_image_url = "http://assets.codecloudapp.com/sites/57b22f546e6f6476c6020000/image/png/1446826281000/stc-logo-holiday-360 copy.png";
                        val.store_image = "http://assets.codecloudapp.com/sites/57b22f546e6f6476c6020000/image/png/1446826281000/stc-logo-holiday-360 copy.png";
                    } else {
        ...
        if(type=="events"){
            ...
            if ((val.event_image_url_abs).indexOf('missing.png') > -1) {
                val.event_image_url_abs = "http://assets.codecloudapp.com/sites/57b22f546e6f6476c6020000/image/png/1446826281000/stc-logo-holiday-360 copy.png"
            }
        }
        var rendered = Mustache.render(template_html,val);
         item_rendered.push(rendered);
...
function renderTrending(container, template, collection){
    ...
    $.each( collection , function( key, val ) {
        ...
        if (post.image_url.indexOf('missing.png') > -1) {
            val.post_image = "http://assets.codecloudapp.com/sites/57b22f546e6f6476c6020000/image/png/1446826281000/stc-logo-holiday-360 copy.png";
        } else {
